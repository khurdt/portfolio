...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/contact.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  function validatePhone() {
    var value = phoneInput.value; // if (value.length !== 10) {
...
function sendContactInfo(_x) {
  return _sendContactInfo.apply(this, arguments);
}

function _sendContactInfo() {
  _sendContactInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _axios.default.post('https://73v00p9r39.execute-api.ca-central-1.amazonaws.com/dev', {
              data: data
